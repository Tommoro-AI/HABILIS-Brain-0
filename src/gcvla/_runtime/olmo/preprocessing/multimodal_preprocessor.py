...
class ExamplePreprocessor:
    ...
    def __call__(
        ...
        hbz_wrist_geometry_target = example.get("hbz_wrist_geometry_target")
        if hbz_wrist_geometry_target is not None:
            out["hbz_wrist_geometry_target"] = np.asarray(hbz_wrist_geometry_target, dtype=np.float32)
        hbz_wrist_geometry_target_is_valid = example.get("hbz_wrist_geometry_target_is_valid")
        if hbz_wrist_geometry_target_is_valid is not None:
            out["hbz_wrist_geometry_target_is_valid"] = np.asarray(hbz_wrist_geometry_target_is_valid, dtype=np.bool_)
